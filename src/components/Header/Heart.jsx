...
function Heart({ setHeartPopUp, heartPopUp,emojiPopUp, setEmojiPopUp  }) {
                    ...
                    <div className='animate-slide-in w-[472px] max-smm:w-full smm:right-[10px] h-[635px] lg:h-[715px]  rounded-[20px] top-2 fixed' onClick={(e) => e.stopPropagation()}>
                        <div className=' flex mb-3 gap-3' >
                            <div
                                ...
                                <PiHandbagSimpleBold /> {isToggled && <p>Basket</p>}
                            </div>
                            <div
                                onClick={handleSecondDivClick}
                        ...
                        {!isToggled && (
                            <div className='bg-white rounded-[20px] max-smm:w-full smm:right-[10px] h-[570px] lg:h-[650px]' >
                                <div className='p-5 flex flex-col gap-5 justify-between h-full'>
                                    ...
                                    <div className='flex items-center gap-5'>
                                        ...
                                        <button onClick={loginClick} className='px-5 py-2 border-2 cursor-pointer rounded-[10px] max-smm:px-2 smm:px-5 max-smm:text-[12px]'>Login</button>
                                    </div>
                                </div>
                            </div>
                        )}
